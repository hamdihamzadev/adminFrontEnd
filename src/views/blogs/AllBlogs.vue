        ...
        <b-container class="p-4" fluid>
            <div>
                <div class="d-flex justify-content-between mt-5 flex-column flex-md-row gap-3">
                    ...
                    <SearchTable />
                    <!----- add prduct ----->
                    <b-button @click="$router.push('/createblog/1')">Create product</b-button>
                </div>

                <!----- TABLE PRODUCT ----->
                <b-table responsive striped hover :items="AllBlogs" :fields="fields" sort-icon-left
                    :per-page="perPage" :current-page="currentPage" class="mt-2" id="my-table">
                ...
                return this.$store.state.blog.blogs
                    ...
                    .map(ele => {
                        ...
                        return {
                            ...
                            Category :{id:category ? category.id : '', name:category ? category.name :''},
