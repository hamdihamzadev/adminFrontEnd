            ...
            <b-row class="align-items-center justify-content-between">
                ...
                <b-col sm="6">
                    <b-input-group size="sm">
                        <b-form-input class="bg-transparent" id="filter-input" v-model="filter" type="search"
        ...
        methods: {
            ...
            handleActionChange(ev, data, index) {
                ...
                if (ev.target.value === 'edit') {
                    ...
                    if (userConfirmed) {
                        this.$store.dispatch('blogcategories/ac_updateCategory', {
                            id,
                            formCategoryUpdate
                        })
                        // reset value select
                ...
                if (this.textBtnModal === 'Update') {
                    ...
                    if (this.imageUpload === '') {
                        ...
                        if (this.category.image !== '' && this.category.name !== '') {
                            this.$store.dispatch('blogcategories/ac_addCategory', formData)
                            this.onHide()
                        }
                    }
                }
